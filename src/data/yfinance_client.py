...
def fetch_market_snapshot(ticker: str, company_name: str | None = None) -> MarketSnapshot:
    ...
    analyst_targets = fetch_analyst_price_targets(ticker)
    return MarketSnapshot(
        ...
        target_mean_price=analyst_targets.get("target_mean_price"),
        target_median_price=analyst_targets.get("target_median_price"),
        target_high_price=analyst_targets.get("target_high_price"),
        target_low_price=analyst_targets.get("target_low_price"),
        number_of_analyst_opinions=analyst_targets.get("number_of_analyst_opinions"),
        recommendation_mean=analyst_targets.get("recommendation_mean"),
